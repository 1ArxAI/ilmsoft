...
DROP FUNCTION IF EXISTS public.generate_bulk_fees(uuid, text[]);
DROP FUNCTION IF EXISTS public.generate_bulk_fees(uuid, text[], uuid[], boolean);

-- 2. Recreate generate_bulk_fees as SECURITY DEFINER
